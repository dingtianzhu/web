...
var about = new Vue({
    ...
    data: {
        person: {
            ...
            name: '丁天柱',
            job: '高级开发工程师',
            info: '<strong>2013</strong>年进入计算机行业;<strong>2014</strong>年后半年到<strong>2015</strong>年初，进行学习并独立开发;<strong>2015</strong>年夏参加学校企业合作在中软国际进行过1个月的前端开发学习。 至今已有3年编程开发经验。大学就读于天津理工大学计算机科学与工程学院计算机科学与技术专业。学习过计算机相关的科目有：<code>C语言、C++语言、Java语言、C#语言、计算机操作系统、数据库系统概论、软件工程导论、计算机组成原理、计算机网络、编译原理、计算机安全防御</code>等学科。擅长<strong>PHP/Java+H5全栈开发, app开发,微信小程序开发、 算法, 爬虫, 大数据</strong>等;熟悉网站的开发到服务其搭建再到网站发布运营。熟悉的前端框架有<kbd>bootstrap3</kbd>和<kbd>4.0</kbd>，掌握<kbd>Vuejs</kbd>、<kbd>react</kbd>等基于<kbd>ES6</kbd>的组件化开发。熟悉掌握后端开发框架<kbd>ThinkPHP5.0</kbd>、<kbd>laravel</kbd>各个版本、<kbd>yii2.0</kbd>和<kbd>SpringMVC</kbd>。能独立搭建<kbd>LNMP</kbd>、<kbd>LAMP</kbd>等服务器运行环境。熟练的搭建数据库以及优化关系型数据库。熟练的书写各类第三方接口以及数据对接交互。熟练的使用<kbd>git</kbd>、<kbd>svn</kbd>能进行定时的代码管理和更新。期间做过一年的外包兼职。曾效力于：天津汇强科技有限公司、华胜天成科技股份有限公司以及菲戈博特智能科技有限公司。分别担任过<code>PHP后台开发工程师、 运维工程师以及全栈开发工程师。为人随和，思维清晰，热爱生命、热爱学习。生命不休、学习不止。</code>',
